...
const COLOR_KEYS = [
  ...
  /**
  * Map a fluent-style palette to a set of workbench color customizations focused on
  * title bar, activity/status bars and related chrome. The palette is expected to
