/* lib/colorPicker/messageHandler.js
   Message handler glue: routes webview messages to mapping, scheduling and config writes.
   createMessageHandler({ cfgWriter, mapper, scheduler, panel, context, targetsToUpdate, deps }) => { onMessage }
*/
